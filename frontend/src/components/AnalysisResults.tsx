    ...
    return (
      <div className="relative overflow-hidden rounded-md border-2 border-zinc-700 bg-zinc-800/50 p-6">
        <div className="space-y-6">
          ...
          <ComplexitySection time={results.timeComplexity} space={results.spaceComplexity} />
          <FeedbackSection feedback={results.improvements} title="Improvements" emptyMessage="No improvements suggested" />
        </div>
        {isStale && (
          <div
